<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:141:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.backend.devp\backend\public/../application/backend\view\dnspod\dnspod_add.html";i:1550835576;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<form action="" method="post" class="form form-horizontal" id="form-record-add">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text disabled valid" value="<?php echo $domain; ?>"
			...
			$("#form-record-add").validate({
				...
				submitHandler: function (form) {
	                ...
	                $.ajax({
	                    ...
	                    data: data,
	                    url: '<?php echo url("dnspod/dnspod_sumbit"); ?>',
