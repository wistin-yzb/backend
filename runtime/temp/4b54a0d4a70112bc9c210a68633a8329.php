<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:140:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.backend.devp\backend\public/../application/backend\view\domain\group_add.html";i:1550570027;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
	<article class="page-container">
		<form action="" method="post" class="form form-horizontal" id="form-group-add">
			...
			<div class="row cl">
				<label class="form-label col-xs-3 col-sm-2" style="text-align:right;" ><span
					class="c-red">*</span>短信通知分组：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box">
					  <select class="select" size="1" name="mobile_group_info">
					  <option value=0>未分组</option>
					   <!--<?php if(is_array($group_list) || $group_list instanceof \think\Collection || $group_list instanceof \think\Paginator): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->					    
					    <option value="<?php echo $vo['group_id']; ?>-<?php echo $vo['group_name']; ?>" <?php if($info['mobile_group_id'] == $vo['group_id']): ?>selected<?php endif; ?>><?php echo $vo['group_name']; ?></option>
			...
			$("#form-group-add").validate({
				...
				submitHandler: function (form) {
	                ...
	                $.ajax({
	                    ...
	                    data: data,
	                    url: '<?php echo url("domain/group_submit"); ?>',
