<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:142:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.backend.devp\backend\public/../application/backend\view\server\server_list.html";i:1550134191;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"> <a href="javascript:;"
				onclick="server_add('添加服务器','<?php echo url('server/server_add'); ?>','750','700')"
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">				
				...
				<tbody>
					...
					<tr class="text-c">
						...
						<td><?php echo $vo['domain1']; ?></td>
						<td><?php echo $vo['domain2']; ?></td>
						<td><?php echo $vo['domain3']; ?></td>
						<td><?php echo $vo['domain4']; ?></td>
						<td><?php echo $vo['domain5']; ?></td>										
