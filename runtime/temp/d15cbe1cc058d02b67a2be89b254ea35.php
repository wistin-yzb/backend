<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:138:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.backend.devp\backend\public/../application/backend\view\line\line_list.html";i:1550133152;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
						...
						<td class="td-manage">
							<?php if($vo['status']==2): ?> <a style="text-decoration: none"
							  ...
							  <a title="编辑" href="javascript:;" onclick="line_edit('修改案例','<?php echo url('line/line_add'); ?>','<?php echo $vo['id']; ?>','700','500')"
								...
								class="ml-5" style="text-decoration: none">
								<i class="Hui-iconfont">&#xe6e2;</i></a>
								<a data-title="服务器列表" href="javascript:;" data-href="<?php echo url('server/server_list'); ?>?n=<?php echo $vo['name']; ?>" onclick="Hui_admin_tab(this)"
								class="ml-5" style="text-decoration: none">服务器</a>
								<a data-title="落地域名列表" href="javascript:;" data-href="<?php echo url('luodi/luodi_list'); ?>?n=<?php echo $vo['name']; ?>" onclick="Hui_admin_tab(this)"
