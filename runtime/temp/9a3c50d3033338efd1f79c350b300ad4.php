<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:140:"F:\xampp-win32-5.6.3-0-VC11-installerroot\xammp\htdocs\www\www.backend.devp\backend\public/../application/backend\view\luodi\luodi_list.html";i:1550715514;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	...
	<div class="page-container">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">				
				<thead>
				<tr role="row"><th scope="col" colspan="14" rowspan="1">注：案例&lt;&lt;<font color="#5a98de"><?php echo $n; ?></font>&gt;&gt;所有落地域名列表</th></tr>
					<tr class="text-c">
						<th width="80">ID</th>
						<th width="200">域名</th>
						<th width="200">备注</th>
